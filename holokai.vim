...
if &t_Co > 255
    ...
    hi CursorLine                   ctermbg=245 cterm=none
    ...
    hi Cursor           ctermfg=16  ctermbg=27
    ...
    hi Special          ctermfg=207  

    hi Statement        ctermfg=220             cterm=bold 
    hi StatusLine       ctermfg=24 ctermbg=253
    hi StatusLineNC     ctermfg=244 ctermbg=232
    hi StorageClass     ctermfg=112
    hi Structure        ctermfg=75
    hi Tag              ctermfg=220
    hi Title            ctermfg=166
    hi Todo             ctermfg=231 ctermbg=202 cterm=bold
